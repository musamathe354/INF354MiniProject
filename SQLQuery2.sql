...
CREATE TABLE Client_Furniture
(
	Fk_F_ID INT FOREIGN KEY REFERENCES Furniture(F_ID),
	Fk_C_ID INT FOREIGN KEY REFERENCES Client(C_ID),
	ClientFurnitureRent datetime
)
